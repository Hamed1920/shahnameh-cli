...
export function ContextMenu({
  ...
  // Measure, then clamp so a menu opened near an edge opens back toward the middle.
  useLayoutEffect(() => {
  ...
  return createPortal(
    <motion.div
      ...
      className="fixed z-120 min-w-56 max-w-72 origin-top-left rounded-lg border border-edge-strong bg-raise p-1 text-[13px] shadow-[0_16px_40px_-12px_rgba(0,0,0,0.85)]"
    >
      {entries.map((entry, i) => {
